      ...
      <CardContent className="p-0">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/4 p-6 bg-gray-50 flex flex-col justify-between border-l border-gray-200">
            ...
            <div className="mt-4">
              <Link href={`/athlete-opportunities/${id}`}>
...
const appliedCampaigns: Campaign[] = [
  ...
  {
    id: 3,
    title: "Reliance Foundation Young Champs - Football Talent Hunt",
    amount: 20000,
    ...
    company: {
      ...
      description: "Corporate foundation focused on identifying and developing football talent across India through a structured pathway.",
      logo: "/logos/reliance-logo.svg",
    },
    status: "confirmed",
    dateRange: "20.02.25 - 10.03.25",
