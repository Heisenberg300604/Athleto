            ...
            <div className="space-y-6">
              {["Country", "City", "Industry"].map((filter, index) => (
                <div key={filter} className="space-y-2">
                  ...
                  <select aria-label={filter} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 ease-in-out">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-indigo-600 shadow-md rounded-lg p-6">
              <div className="flex items-start justify-between">
                ...
                <button className="text-gray-400 hover:text-blue-500" title="Add to favorites">
                  <Heart size={24} />
                </button>
              </div>
            </div>
